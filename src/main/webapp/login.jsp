...
<section class="loginF">
    <form action="admin-login" class="Loginform" method="get">
        <h2>Login</h2>
        <p class="loginP">If you've created an account with us, please enter.</p>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <p class="loginP">Forgot Password?</p>
    ...
    <div class="signup">
        ...
        <p class="signupPara"> Registering for this site allows you to access your order status and history. We’ll get a new account set up for you in no time. We’ll get a new account set up for you in no time. For this will only ask you for information necessary to make the purchase process faster and easier</p>
       <a href="signup.jsp">
